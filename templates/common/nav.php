    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="/~lbaw1433/proto/listAllGames.php">All Games</a></li>
                        <li><hr></li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href="/~lbaw1433/backoffice.php"><span class="glyphicon glyphicon-lock"></span> Admin </a></li>
                <li><a href="/~lbaw1433/cart.php"><span class="badge">2</span><span class="glyphicon glyphicon-shopping-cart"></span> Cart </a></li>
                <li><a href="/~lbaw1433/profile.php"><span class="glyphicon glyphicon-user"></span> Profile </a></li>
