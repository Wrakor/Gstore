...
<?php include_once "templates/common/nav.php"; ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <!-- Left Side -->
       		<?php include_once "templates/common/categoryColumn.php" ?>
                    ...
                    <div class="col-md-offset-1">
                        <h2>RPG <small>short for role-playing games...</small>
                            <ul class="view-modes list-inline pull-right">
                                ...
                                <li class="active"><a href="products3.php"> <span class="glyphicon glyphicon-list"></span></a></li>
                            </ul>
                        </h2>
                        ...
                        <div class="container-fluid">
                            ...
                            <?php include_once "itemlist3.php"; ?>
