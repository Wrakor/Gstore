...
<div class="container">
    <div class="col-md-3">
        ...
        <div class="list-group side-menu">
            ...
            <a href="shoppinghistory.php" class="list-group-item active"><span class="glyphicon glyphicon-euro"></span>Shopping History</a>
    ...
    <div class="col-md-9">
        <div class="row">
            <div class="col-md-offset-1">
                <h2>Shopping History <small>with your purchase information.</small></h2>
                <hr class="colorgraph">
