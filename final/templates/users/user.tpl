                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <ul class="list-unstyled">
                                <li><a href="{$BASE_URL}pages/users/edituser.php" data-toggle="tooltip" data-original-title="Edit your profile" data-placement="right"><span style="padding-left: 85%" class="glyphicon glyphicon-pencil"> Edit </span></a></li>
                            </ul>
